...
#exchange = ccxt.okex()   # 其他交易所为huobipro, binance, okex
exchange = ccxt.okex({'hostname': 'ouyi.cc'})   # 其他交易所为huobipro, binance, okex
# =====设置参数
time_interval = '1d'
N = 20  # 计算最近N天的涨跌幅
...
for symbol in ['BTC/USDT', 'ETH/USDT']:
    ...
    # print('symbol:%s,df:%s'%(symbol,df))
    df.rename(columns={0: 'MTS', 1: 'open', 2: 'high',
                       3: 'low', 4: 'close', 5: 'volume'}, inplace=True)  # 重命  名
